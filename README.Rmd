...
> ⚠️ **Warning!** - 
> *Due to the large file size of the EWSNet model weights (\~230MB), `EWSmethods` does not come bundled with them. Users must download weights using `ewsnet_reset()` before interfacing with EWSNet.*.
