...
We can then use the resulting figures to identify oncoming transitions. In this case, we would expect no transition as the data originates from a normal distribution. This is evident with no consistent increasing correlation with time: 
