...
abundance data via
[`uniEWS()`](https://duncanobrien.github.io/EWSmethods/reference/uniEWS.md)
but decide to initially focus on rolling windows. We would therefore
parameterise the function to do so as below:
...
![](reference/figures/README-rolling_plot-1.png)
...
![](reference/figures/README-expanding_plot-1.png)
...
[`uniEWS()`](https://duncanobrien.github.io/EWSmethods/reference/uniEWS.md)
function in `EWSmethods`, using the `trait` argument.
...
![](reference/figures/README-expanding_plot_trait-1.png)
...
![](reference/figures/README-expanding_oct_plot-1.png)
