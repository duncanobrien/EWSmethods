...
resource_files:
  - vignettes/ewsmethods_eg_fig.pdf
vignette: >
...
```{r vis_data,dpi=200, fig.width=5,fig.height=4}
...
```{r fig_pdf, echo=F,fig.align='center'}
knitr::include_graphics("../man/figures/ewsmethods_eg_fig.pdf")
```
...
```{r rolling_ews_fig,dpi=200,fig.width=5,fig.height=5,echo=F}
rolling_ews_eg$plot
```
