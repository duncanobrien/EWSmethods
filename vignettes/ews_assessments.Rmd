...
<a href="https://duncanobrien.github.io/EWSmethods/"><img src="vignettes/ewsmethods_eg_fig.pdf" max-width="100%"/></a>
...
```{r rolling_ews_fig,dpi=200,fig.width=5,fig.height=4,echo=F}
rolling_ews_eg$plot
```
