...
ewsnet_init(envname = "EWSNET_env", pip_ignore_installed = FALSE,  conda_refresh = FALSE, auto=TRUE) 
```
...
```{r create_white_data, warning = FALSE,dpi=200, fig.width=5,fig.height=4}
...
```{r expanding_ewsnet, warning = FALSE,dpi=200, fig.width=5,fig.height=4}
...
You may want to remove Python downloads and environment setup by `EWSmethods`. You can acheive this using `ewsnet_init()` and the `conda_refresh =` argument.
